public class PhraseOMatic {
    public static void main(String[] args) {
        ...
        String[] wordListTwo = {"loosely coupled", "six sigma", "asynchronous", "event driven", "pub-sub", "IoT", "cloud native", "service oriented", "containerized", "serverless", "microservices", "distribited ledger"};
